...
- **Conducted comprehensive web research** on cutting-edge Unity + AI development techniques for 2025
- **Identified Cursor AI integration** as primary productivity multiplier for Unity C# development
...
- **Unity Rules**: `unity-csharp-standards-auto.mdc` - Automatic code quality enforcement for all C# files
...
- **Performance optimization**: Mobile-first approach with 60fps target
- **Cross-platform deployment**: Unity WebGL for universal accessibility
...
- **VSCode/Cursor settings**: Optimized IDE configuration for Unity + AI development
...
5. **Modern Unity Standards**: C# 8.0+, ScriptableObject architecture, event-driven design
...
- **Unity 2022.3 LTS**: Game engine with WebGL deployment capability
- **Cursor AI**: Context-aware code generation and debugging assistance
- **Modern C#**: Nullable reference types, async/await patterns, SOLID principles
